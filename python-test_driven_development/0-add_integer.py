...
def add_integer(a, b=98):
    ...
    If `a` or `b` are floats, they are converted to integers before performing the addition.
    
    Args:
        a (int, float): The first number. Must be an integer or a float.
        b (int, float, optional): The second number. Defaults to 98. Must be an integer or a float.
